...
export class AuthService {
  ...
  login(data: LoginData): void {
    if (data.email !== 'saboridoagustin@mail.com' || data.password !== '123456' , data.email !== 'davidrivas@hotmail.com' || data.password !== '123456', data.email !== 'gonzagarcia@hotmail.com' || data.password !== '123456' ) {
